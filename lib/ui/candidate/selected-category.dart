                          ...
                          children: [
                            InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                    color: male ? Color(0xFF00A69D).withOpacity(0.2) : Color(0xFFFFFFFF),
                                    borderRadius: BorderRadius.circular(6),
                                    border: Border.all(
                                      width: male ? 1.4 : 1,
                                      color: male ? Color(0xFF00A69D) : Color(0xFFEBF1F4),
                                    )
                                ),
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontFamily: 'Gelion',
                                      fontSize: 16,
                                      color: male ? Color(0xFF00A69D) : Color(0xFF717F88),
                                    ),
                                  ),
                                ),
                              ),
                            ...
                            InkWell(
                              ...
                              child: Container(
                                ...
                                padding: EdgeInsets.only(top:18 ,bottom: 18),
                                decoration: BoxDecoration(
                                    color: female ? Color(0xFF00A69D).withOpacity(0.2) : Color(0xFFFFFFFF),
                                    borderRadius: BorderRadius.circular(6),
                                    border: Border.all(
                                      width: female ? 1.4 : 1,
                                      color: female ? Color(0xFF00A69D) : Color(0xFFEBF1F4),
                                    )
                                ),
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      fontFamily: 'Gelion',
                                      fontSize: 16,
                                      color: female ? Color(0xFF00A69D) : Color(0xFF717F88),
                                    ),
                                  ),
                                ),
                              ),
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                      ...
                                      size: 18,
                                      color: liveIn ? Color(0xFF00A69D) : Color(0xFFC4C4C4)
                                  ),
                                  SizedBox(width: 7.75),
                                  Text(
                                    "Live in",
                                ...
                                children: [
                                  Icon(
                                      custom
                                          ...
                                          : Icons.radio_button_unchecked_rounded,
                                      size: 18,
                                      color: custom ? Color(0xFF00A69D) : Color(0xFFC4C4C4)
                                  ),
                                  SizedBox(width: 7.75),
                                  Text(
                                    "Custom",
                        ...
                        Container(
                          ...
                          child: Column(
                            ...
                            children:[
                              ...
                              SizedBox(height: 12),
                              Text(
                                "Fluent in ${candidate.language.split(',').length} language(s) - ${candidate.language}",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                  fontWeight: FontWeight.w400,
                                  fontFamily: 'Gelion',
